...
export const cities: City[] = [
  ...
  { name: 'Delhi', country: 'India', countryCode: 'IN', flag: '🇮🇳', continent: 'Asia', lat: 28.6139, lng: 77.2090, timezone: 'Asia/Kolkata' },
  { name: 'Mumbai', country: 'India', countryCode: 'IN', flag: '🇮🇳', continent: 'Asia', lat: 19.0760, lng: 72.8777, timezone: 'Asia/Kolkata' },
  ...
  { name: 'Seoul', country: 'South Korea', countryCode: 'KR', flag: '🇰🇷', continent: 'Asia', lat: 37.5665, lng: 126.9780, timezone: 'Asia/Seoul' },
  ...
  { name: 'Istanbul', country: 'Turkey', countryCode: 'TR', flag: '🇹🇷', continent: 'Asia', lat: 41.0082, lng: 28.9784, timezone: 'Europe/Istanbul' },
  // Europe
  { name: 'London', country: 'UK', countryCode: 'GB', flag: '🇬🇧', continent: 'Europe', lat: 51.5074, lng: -0.1278, timezone: 'Europe/London' },
  { name: 'Paris', country: 'France', countryCode: 'FR', flag: '🇫🇷', continent: 'Europe', lat: 48.8566, lng: 2.3522, timezone: 'Europe/Paris' },
  { name: 'Berlin', country: 'Germany', countryCode: 'DE', flag: '🇩🇪', continent: 'Europe', lat: 52.5200, lng: 13.4050, timezone: 'Europe/Berlin' },
  ...
  // North America
  { name: 'New York', country: 'USA', countryCode: 'US', flag: '🇺🇸', continent: 'North America', lat: 40.7128, lng: -74.0060, timezone: 'America/New_York' },
  { name: 'Los Angeles', country: 'USA', countryCode: 'US', flag: '🇺🇸', continent: 'North America', lat: 34.0522, lng: -118.2437, timezone: 'America/Los_Angeles' },
  { name: 'Chicago', country: 'USA', countryCode: 'US', flag: '🇺🇸', continent: 'North America', lat: 41.8781, lng: -87.6298, timezone: 'America/Chicago' },
  { name: 'San Francisco', country: 'USA', countryCode: 'US', flag: '🇺🇸', continent: 'North America', lat: 37.7749, lng: -122.4194, timezone: 'America/Los_Angeles' },
  ...
  { name: 'Miami', country: 'USA', countryCode: 'US', flag: '🇺🇸', continent: 'North America', lat: 25.7617, lng: -80.1918, timezone: 'America/New_York' },
  { name: 'Houston', country: 'USA', countryCode: 'US', flag: '🇺🇸', continent: 'North America', lat: 29.7604, lng: -95.3698, timezone: 'America/Chicago' },
  { name: 'Washington D.C.', country: 'USA', countryCode: 'US', flag: '🇺🇸', continent: 'North America', lat: 38.9072, lng: -77.0369, timezone: 'America/New_York' },
  // South America
